        ...
        <div className=''>
            <div className="banner flex flex-col justify-center items-center gap-[35px] h-[50vh] banner">
                ...
                <form className ="flex items-center "action="" onSubmit={Text}>
                    <input className="w-full h-full p-[14px] border-2 border-[#DEDEDE] rounded-l-[8px]" name="text" placeholder="Search here..."type="text" />
                    <input className="w-[110px] h-[50px] text-[white] bg-[#FF444A] rounded-r-[8px] "name="submit" type="submit" value="Submit" />
